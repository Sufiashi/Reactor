...
public:
    ...
    void append(const char * data,size_t size);     //把数据·追加到buf_
    void appendwithsep(const char *data,size_t size);      //把数据追加到buf_中，附加头部
    void erase(size_t pos,size_t nn);               //从pos开始，删除nn字节
